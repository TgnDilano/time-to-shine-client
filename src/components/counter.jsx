...
const Counter = () => {
  return (
    <section className="h-[43rem] w-screen relative overflow-hidden text-white">
      <div className="w-full h-full absolute z-10 flex items-center justify-center flex-col gap-y-14">
        <img src={timer} className="absolute z-0 w-full object-fill h-full" />
...
const CounterBox = ({ label }) => {
  return (
    <div className="flex flex-col items-center justify-center">
      <div className="bg-risenBlack text-white p-12 lg:p-16 xl:p-20 flex items-center justify-center  text-8xl">
        01
      </div>
